  ...
  return (
    <NodeButton
      className={classNames('group', {
        'bg-transparent text-conformity-elements-item-contentDefault hover:text-conformity-elements-item-contentActive hover:bg-conformity-elements-item-backgroundActive':
          !selected,
        'bg-conformity-elements-item-backgroundAccent text-conformity-elements-item-contentAccent': selected,
      })}
      depth={depth}
...
function File({ file: { depth, name }, onClick, selected, unsavedChanges = false }: FileProps) {
  return (
    <NodeButton
      className={classNames('group', {
        'bg-transparent hover:bg-conformity-elements-item-backgroundActive text-conformity-elements-item-contentDefault': !selected,
        'bg-conformity-elements-item-backgroundAccent text-conformity-elements-item-contentAccent': selected,
      })}
      depth={depth}
      iconClasses={classNames('i-ph:file-duotone scale-98', {
        'group-hover:text-conformity-elements-item-contentActive': !selected,
      })}
      onClick={onClick}
    >
      <div
