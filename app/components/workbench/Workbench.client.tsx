        ...
        >
          <div
            className={classNames(
              'fixed top-[calc(var(--header-height)+1.5rem)] bottom-6 w-[var(--workbench-inner-width)] mr-4 z-0 transition-[left,width] duration-200 enormity-ease-cubic-bezier',
              {
          ...
          >
            <div className="absolute inset-0 px-6">
              <div className="h-full flex flex-col bg-conformity-elements-background-depth-2 border border-conformity-elements-borderColor shadow-sm rounded-lg overflow-hidden">
